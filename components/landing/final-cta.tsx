      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
        ...
        >
          ...
          <div className="mt-7 flex justify-center">
            <a
              href="#get-started"
              className="inline-flex items-center justify-center gap-2 rounded-[8px] bg-white px-6 py-3 text-sm font-semibold text-ink-strong transition-colors hover:bg-white/90"
            >
              Get started
